...
#SBATCH -o /lium/raid-a/xcoupe/out/train_output.out                # output file name
#SBATCH -e /lium/raid-a/xcoupe/out/train_error.out                 # error file name
...
python3 -u train.py /lium/corpus/base/LibriSpeech/ ./logs/ --mask --alpha=1